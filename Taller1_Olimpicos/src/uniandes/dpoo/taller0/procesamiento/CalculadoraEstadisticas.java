...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Calcula el país de un atleta que entra por parametro
	 * @param nombreAtleta
	 * @return Un string que representa el país de un atleta que entra por parametro
	 */
